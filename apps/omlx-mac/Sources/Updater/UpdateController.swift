...
final class UpdateController: ObservableObject {
    ...
    init(
        ...
        let prefs = Self.readPrefs(from: storeURL) ?? Prefs(
            channel: .stable, autoCheck: false, autoNotify: false, consentGiven: false
        )
    ...
    private struct Prefs: Codable {
        ...
        init(from decoder: Decoder) throws {
            ...
            self.autoCheck = try container.decodeIfPresent(Bool.self, forKey: .autoCheck) ?? false
            self.autoNotify = try container.decodeIfPresent(Bool.self, forKey: .autoNotify)
                ?? false
            self.consentGiven = try container.decodeIfPresent(Bool.self, forKey: .consentGiven)
                ?? false
        ...
        func encode(to encoder: Encoder) throws {
            ...
            try container.encode(consentGiven, forKey: .consentGiven)
